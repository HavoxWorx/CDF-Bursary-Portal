/* === What I want  === */
// An overall logo / Branding guide for the website that doubles as a home link whenever anyone is lost to ind their way back home
// --------- Imports ---------- //

import { useMenu, useTheme } from '@/app/(atoms)/utility/component-states';
import useMediaQuery from '@/app/(atoms)/utility/device-viewport';
...
//       className={menu ? 'while-menu-closed' : 'while-menu-open'}
//       href={'/'}
//     >I am the logo now</label>
//   );
// }
